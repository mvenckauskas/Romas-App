...
- Aplikacija turi 4 atskirus naudotojų puslapius: `naudotojas.html`, `pranesejas.html`, `partneris.html` ir `moderatorius.html`.
- `index.html` yra tik pasirinkimo puslapis, o ne visų funkcijų ekranas.
- Dalyvis mato konferencijos programą, pranešimų aprašymus ir pranešėjus tik `naudotojas.html` puslapyje.
...
- Dalyvis gali pasirinkti naudotojo tipą, pvz. Dalyvis, VIP dalyvis, Studentas arba Spauda.
- Dalyvis gali užduoti klausimus partneriams.
- Pranešėjas mato jam užduotus klausimus ir atsakymus tik `pranesejas.html` puslapyje.
- Partneris mato laiko rezervacijas ir partnerio klausimus tik `partneris.html` puslapyje.
- Moderatorius mato visus klausimus, atsakymus ir rezervacijas tik `moderatorius.html` puslapyje.
- Vieno naudotojo veiksmai nėra rodomi kaip mygtukai kitam naudotojui: pvz., moderatorius negali atsakyti, pranešėjas negali rezervuoti partnerio laiko.

## Kaip pamatyti aplikaciją, jei esate naujas programuotojas

Ši aplikacija yra paprastas statinis puslapis. Tai reiškia, kad nėra prisijungimų, serverio ar duomenų bazės. Yra keli svarbiausi failai:

- `index.html` – pradinis puslapis, kuriame pasirenkate naudotoją.
- `naudotojas.html` – dalyvio puslapis.
- `pranesejas.html` – pranešėjo puslapis.
- `partneris.html` – partnerio puslapis.
- `moderatorius.html` – moderatoriaus puslapis.
...
Kol tokios viešos nuorodos nėra, naršyklė neturi iš kur paimti HTML puslapių, `styles.css` ir `app.js` failų.
...
Kadangi projektas susideda tik iš HTML puslapių, `styles.css` ir `app.js`, jį galima hostinti bet kurioje statinių puslapių platformoje:
